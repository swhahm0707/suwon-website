    ...
    >
      ...
      <section className="px-[5%] pb-24 max-w-7xl mx-auto space-y-24 md:space-y-36">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center lg:flex-row-reverse">
          ...
          {/* Horizontal scroll container for Costume Production images */}
          <div className="flex flex-nowrap gap-6 overflow-x-auto pb-6 scrollbar-thin scrollbar-thumb-[#839958]/40 scrollbar-track-transparent snap-x snap-mandatory pt-2 min-w-0 lg:order-1">
            {[
              ...
              <div key={index} className="flex-shrink-0 w-[280px] sm:w-[340px] xl:w-[420px] aspect-[4/3] snap-center bg-transparent rounded-lg shadow-md border border-[#0A3323]/10 flex items-center justify-center overflow-hidden">
                <PortfolioImage
                  src={img.src}
                  alt={img.alt}
                  className="w-full h-full object-contain rounded animate-fade-in"
